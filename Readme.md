...
* Студент: [Данил Номоконов](https://up.htmlacademy.ru/univer-html1/2/user/2678237).
* Наставник: `Гоша`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-univer-htmlcss-1/2678237-sedona-2) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
